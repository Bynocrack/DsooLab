...
public class VentanaMenuCliente extends javax.swing.JFrame {
    ...
    public VentanaMenuCliente(vista.VentanaPrincipal ventanaPrincipal, modelo.Banco banco, modelo.Cliente cliente) {
    ...
    private void btnConsultarCuentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarCuentasActionPerformed
        ...
        for (modelo.Cuenta c : cliente.getCuentas()) {
    ...
    private void btnVerMovimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerMovimientosActionPerformed
        ...
        if (seleccion != null) {
            ...
            modelo.Cuenta cuenta = cliente.getCuentas().stream()
    ...
    private void mostrarMovimientosCuenta(modelo.Cuenta cuenta) {
        ...
        for (modelo.Transaccion t : cuenta.getMovimientos()) {
            ...
            movimientos.append("Tipo: ").append(t instanceof modelo.Deposito ? "DEPÓSITO" : "RETIRO").append("\n");
            movimientos.append("─────────────────────────\n");
        }
